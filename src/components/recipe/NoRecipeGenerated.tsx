...
export default function NoRecipeGenerated() {
  return (
    <Card className="finpay-card border-dashed border-2 border-finpay-teal-300/30 bg-gradient-to-br from-finpay-teal-50/50 to-finpay-blue-50/50 dark:from-muted dark:to-muted text-center">
      ...
      <CardContent>
        <p className="text-finpay-gray-600 dark:text-muted-foreground max-w-md mx-auto text-lg leading-relaxed">
