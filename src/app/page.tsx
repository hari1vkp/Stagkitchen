  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-finpay-gray-600 max-w-2xl mx-auto">
      ...
      <div className="finpay-card finpay-card-hover">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-sm font-medium text-finpay-gray-500 uppercase tracking-wide">YOUR RECIPE BALANCE</h2>
            <p className="text-3xl md:text-4xl font-bold finpay-gradient-text mt-1">∞ Unlimited</p>
            <p className="text-finpay-gray-600 mt-2">AI-Powered • No Limits • Instant Generation</p>
          </div>
      ...
      {/* Tabs */}
      <div className="flex space-x-1 bg-finpay-gray-100 p-1 rounded-xl">
        <button
          onClick={() => setActiveTab('form')}
          className={`flex-1 py-3 px-6 rounded-lg font-semibold transition-all duration-300 ${
            activeTab === 'form'
              ? 'bg-white text-finpay-teal-600 shadow-md'
              : 'text-finpay-gray-600 hover:text-finpay-gray-800'
          }`}
        >
          RECIPE GENERATOR
        </button>
      ...
      {activeTab === 'form' ? (
        <div className="space-y-8">
          ...
          {isLoading && (
            <div className="finpay-card text-center">
              ...
              <p className="text-lg text-finpay-gray-600 mt-4">Generating your masterpiece...</p>
            </div>
          )}

          {error && (
            <div className="finpay-card border-l-4 border-red-500 bg-red-50">
        ...
        <div className="finpay-card text-center">
          <div className="bg-gradient-to-r from-finpay-purple-100 to-finpay-pink-100 p-8 rounded-2xl">
            <Bookmark size={64} className="text-finpay-purple-500 mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-finpay-gray-900 mb-2">Saved Recipes</h3>
            <p className="text-finpay-gray-600 mb-6">Your favorite recipes will appear here</p>
            <Button 
              onClick={() => setActiveTab('form')}
